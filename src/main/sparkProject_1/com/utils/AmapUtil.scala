...
object AmapUtil {
  ...
  def getBusinessFromAmap(long:Double,lat:Double):String={
    ...
    val urlStr = "https://restapi.amap.com/v3/geocode/regeo?location="+location+"&key=526cd8b243182f7e00bd2784edcc4a96"
//     调用请求

   // https://restapi.amap.com/v3/geocode/regeo?location=116.310003,39.991957&key=526cd8b243182f7e00bd2784edcc4a96
